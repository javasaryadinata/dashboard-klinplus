...
<form method="POST" action="{{ route('jadwal.rescheduleUpdate', $order->id_order) }}">
    @csrf
    @method('PUT')
    ...
    <div class="detail-table">
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-md-10">
                ...
                @if(isset($oldOrder))
                    <small class="text-muted">Tanggal lama: {{ $oldOrder->tanggal_pengerjaan }}</small>
                @endif
            </div>
        </div>
        ...
        <div class="row align-items-center mb-3">
            ...
            <div class="col-md-10">
                ...
                @if(isset($oldOrder))
                    <small class="text-muted">Jam lama: {{ \Carbon\Carbon::parse($oldOrder->jam_pengerjaan)->format('H:i') }}</small>
                @endif
            </div>
        </div>
    </div>
